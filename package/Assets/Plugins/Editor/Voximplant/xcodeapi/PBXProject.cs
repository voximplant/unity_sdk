...
namespace Xcodeapi
{
    ...
    public class PBXProject
    {
        ...
        PBXCopyFilesBuildPhaseData FindFrameworksCopyPhase()
        {
            foreach (var pbxCopyFilesBuildPhaseData in m_Data.copyFiles.GetObjects()) {
                if (pbxCopyFilesBuildPhaseData.subfolderSpec == PBXCopyFilesBuildPhaseData.SubfolderSpec.Frameworks) {
        ...
        bool HaveFileGUIDInFilesCopyPhase(PBXCopyFilesBuildPhaseData copyPhase, string fileGUID)
        {
            foreach (var buildFileGUID in copyPhase.files)
            {
                if (m_Data.BuildFilesGet(buildFileGUID).fileRef == fileGUID)
                {
                    return true;
                }
            }
        ...
        // Adds 'Embed Framework' section to project Build Phases
        public void AddDynamicFramework(string targetGuid, string frameworkPathInProject)
        {
            ...
            var embedFrameworksSection = FindFrameworksCopyPhase() ?? PBXCopyFilesBuildPhaseData.Create(
                                             "Embed Frameworks",
                                             PBXCopyFilesBuildPhaseData.SubfolderSpec.Frameworks);

            if (!HaveFileGUIDInFilesCopyPhase(embedFrameworksSection, fileGuid))
            {
        ...
        */
        ...
        internal string AddAppExtension(string mainTarget, string name, string infoPlistPath)
        {
            ...
            var copyFilesBuildPhase = PBXCopyFilesBuildPhaseData.Create("Embed App Extensions",
                PBXCopyFilesBuildPhaseData.SubfolderSpec.Plugins);
