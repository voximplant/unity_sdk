...
namespace Voximplant.Threading
{
    public class InvokePumpBehavior : MonoBehaviour
    {
        private InvokePump _invokePump;

        public InvokePump invokePump
        {
            get { return _invokePump; }
        }

        public InvokePumpBehavior()
        {
            _invokePump = new InvokePump();
        }
    ...
    public class InvokePump : WaitHandle
    {
        ...
        public void Invoke(Action action)
        {
            ...
            if (Thread.CurrentThread.ManagedThreadId == _threadId)
                throw new System.InvalidOperationException(
                    "Never call WaitOne on an InvokePump from the thread that owns it, this will freeze that thread indefinitely.");
        ...
        public void Update()
        {
            ...
            if (this.InvokeRequired)
                throw new System.InvalidOperationException(
                    "InvokePump.Update can only be updated on the thread that was designated its owner.");
