 ...
 * TextureViews.
 */
public class EglRenderer implements org.webrtc.VideoRenderer.Callbacks, VideoSink {
    ...
    public GlTextureFrameBuffer framebuffer;
        ...
        synchronized (handlerLock) {
            ...
            ThreadUtils.invokeAtFrontUninterruptibly(renderThreadHandler, new Runnable() {
                        ...
                        public void run() {
                            ...
                            eglBase = EglBase.createAdaptiveAndMakeCurrent(sharedContext, configAttributes);
                            ...
                            if (versionMatcher.find()) {
                                self.glMajorVersion = Integer.parseInt(versionMatcher.group(1));
                            } else {
    ...
    public void renderFrame(VideoRenderer.I420Frame frame) {
        VideoFrame videoFrame = VideoFrame.fromI420Frame(frame);
        onFrame(videoFrame);
        videoFrame.release();
    }
    ...
    private void renderFrameOnRenderThread() {
        GlUtil.checkNoGLES2Error("renderFrameOnRenderThread");
        ...
        if (buffer instanceof VideoFrame.TextureBuffer) {
            isYuvBuffer = false;
            throw new RuntimeException("Unsupported texture buffer type");
        } else {
            isYuvBuffer = true;
        ...
        if (shouldRenderFrame) {
            ...
            framebuffer.setSize(drawnFrameWidth, drawnFrameHeight);

            if (this.glMajorVersion == 3) {
            ...
            GlUtil.checkNoGLES2Error("Unbind buffers");
            ...
            if (isYuvBuffer) {
                drawer.drawYuv(yuvTextures,
                        ...
                        drawnFrameHeight, 0, 0, drawnFrameWidth, drawnFrameHeight);
            } else {
                VideoFrame.TextureBuffer textureBuffer = (VideoFrame.TextureBuffer) buffer;
                drawer.drawTexture(textureBuffer, drawMatrix, drawnFrameWidth, drawnFrameHeight, 0, 0,
                        drawnFrameWidth, drawnFrameHeight);
            }

            final long swapBuffersStartTimeNs = System.nanoTime();
            GlUtil.checkNoGLES2Error("Swap buffers");
            // eglBase.swapBuffers();
