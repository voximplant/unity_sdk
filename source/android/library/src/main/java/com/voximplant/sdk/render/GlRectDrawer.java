...
import static com.voximplant.sdk.render.RendererCommon.convertMatrixFromAndroidGraphicsMatrix;
...
public class GlRectDrawer implements RendererCommon.GlDrawer {
    ...
    public void drawOes(int oesTextureId, float[] texMatrix, int frameWidth, int frameHeight,
        ...
        GlUtil.checkNoGLES2Error("drawOes.BindTexture");
        ...
        GlUtil.checkNoGLES2Error("drawOes");
    }
    ...
    public void drawRgb(int textureId, float[] texMatrix, int frameWidth, int frameHeight,
        ...
        GlUtil.checkNoGLES2Error("drawRgb");
    }
    ...
    public void drawYuv(int[] yuvTextures, float[] texMatrix, int frameWidth, int frameHeight,
        ...
        GlUtil.checkNoGLES2Error("drawYuv");
    }
    ...
    private void drawRectangle(int x, int y, int width, int height) {
        ...
        GlUtil.checkNoGLES2Error("drawRectangle");
    }
    ...
    private void prepareShader(String fragmentShader, float[] texMatrix) {
        ...
        glGetIntegerv(GL_MAX_VERTEX_ATTRIBS, result, 0);
        ...
        GlUtil.checkNoGLES2Error("prepareShader");
    }

    @Override
    public void drawTexture(VideoFrame.TextureBuffer buffer, Matrix renderMatrix, int frameWidth, int frameHeight, int viewportX, int viewportY, int viewportWidth, int viewportHeight) {
